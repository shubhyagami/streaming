...
- **Multi‑source streaming** – Search YouTube and Spotify; falls back to YouTube when rate limits are reached.  
- **Real‑time EQ** – 25 presets plus a 32‑band graphic equalizer with live spectrum analysis.  
